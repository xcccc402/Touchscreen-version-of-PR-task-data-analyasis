...
performance_df.to_excel('PerformanceParameters.xls', index = False)
...
Duration_df.to_excel('SequenceDuration.xls', index = False)
...
ResponseInterval_df.to_excel('ResponseInterval.xls', index = False)